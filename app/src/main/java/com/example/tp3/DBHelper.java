...
public class DBHelper extends SQLiteOpenHelper {
    ...
    void addTransaction(Transaction transaction) {
        ...
        values.put(ICON, transaction.getIcon());
        values.put(LABEL, transaction.getLabel());
        values.put(PRICE, transaction.getPrice());
        values.put(DATE, transaction.getDate());
        values.put(ACCOUNT_NUMBER, transaction.getNumCompte());
        values.put(REFERENCE, transaction.getNumRef());
        values.put(BALANCE, transaction.getSolde());
